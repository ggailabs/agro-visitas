...
Deno.serve(async (req) => {
    ...
    const bucketConfig = {
        id: 'soil-analysis-files',
        name: 'soil-analysis-files',
        public: true
    };
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for soil-analysis-files" ON storage.objects FOR SELECT USING (bucket_id = 'soil-analysis-files');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for soil-analysis-files" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'soil-analysis-files');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for soil-analysis-files" ON storage.objects FOR UPDATE USING (bucket_id = 'soil-analysis-files');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for soil-analysis-files" ON storage.objects FOR DELETE USING (bucket_id = 'soil-analysis-files');`
    ];
