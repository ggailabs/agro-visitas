...
Deno.serve(async (req) => {
    ...
    bucketConfig.allowed_mime_types = ["image/jpeg", "image/png", "image/svg+xml"];
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for organization-logos" ON storage.objects FOR SELECT USING (bucket_id = 'organization-logos');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for organization-logos" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'organization-logos');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for organization-logos" ON storage.objects FOR UPDATE USING (bucket_id = 'organization-logos');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for organization-logos" ON storage.objects FOR DELETE USING (bucket_id = 'organization-logos');`
    ];
